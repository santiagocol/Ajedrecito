...
PImage peonB,peonN,torreN1,torreN2,torreB1,torreB2,alfilB1,alfilB2,alfilN1,alfilN2,caballoN1,caballoN2,caballoB1,caballoB2,reinaN,reyN,reinaB,reyB;
...
{  
   for(int b=0; b<16; b++){
    if(mouseX > (fichasB[b][0]-27.5) && mouseX < (fichasB[b][0]+27.5) &&
      ...
      //myPort.write(int(fichasB[ficha][0]/75));
      //myPort.write(int(fichasB[ficha][1]/75));
      break;
    } 
      ...
      ficha = b;
      pintura=1;
      //myPort.write(int(fichasN[ficha][0]/75));
      //myPort.write(int(fichasN[ficha][1]/75));
      break;
    }  
  }
}
...
void mouseDragged()
{
  if( locked ){
    ...
    //image(torreB1,mouseX,mouseY,55,55);
}
